...
exports.homepage = async(req,res) => {
    try {
        ...
        res.status(500).send({ message: error.message || "Error Ouuured"})
    }
}
...
//                     ],
//                     "category": "Chinese", 
//                     "image": "thai-chinese-inspiredfood.jpg"
//                   },
//                   { 
...
//                     ],
//                     "category": "Thai", 
//                     "image": "thai-inspired-vegetables.jpg"
//                   },
//                   { 
...
//                     ],
//                     "category": "Thai", 
//                     "image": "thai-red-chicken-curry.jpg"
//                   },
//                   { 
//                     "name": "Thai Styled Mussels",
//                     "description": `
//     Check the mussels if any are open, give them a tap and they should close; if they do not, discard them.
...
//     When all the mussels have opened and are soft and juicy, they are ready. If any remain closed, discard them.
